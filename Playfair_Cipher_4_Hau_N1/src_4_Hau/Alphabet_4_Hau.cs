...
namespace Playfair_Cipher_4_Hau_N1.src_4_Hau
{
    public static class Alphabet_4_Hau
    {
        ...
        public static int GetPosition_4_Hau(char Chu_cai_4_Hau)
        {
            // Chuyển ký tự thành chữ hoa nếu là chữ thường
            char upperChar_4_Hau = char.ToUpper(Chu_cai_4_Hau);
