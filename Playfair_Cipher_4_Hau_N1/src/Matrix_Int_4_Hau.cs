...
namespace Playfair_Cipher_4_Hau_N1.src
{
    public class Matrix_Int_4_Hau
    {
        ...
        public void InverseMatrix_4_Hau()
        {
            ...
            if (this.Determinant_4_Hau() == 0) throw new Exception("detA != 0");
            var det_inverse = this.Multiplicative_Inverse_4_Hau();
            if (det_inverse < 0)
            {
        ...
        public int Determinant_4_Hau()
        {
            ...
            {
                Matrix_Int_4_Hau subMatrix = this.CopyMatrixExclude_4_Hau(0, i);
                int sub_det = subMatrix.Determinant_4_Hau();
        ...
        {
            int n = N_matrix - 1;
            Matrix_Int_4_Hau matrix_new = new Matrix_Int_4_Hau(n);
            int a = 0;
        ...
        {
            Matrix_Int_4_Hau new_matrix = new Matrix_Int_4_Hau(N_matrix);
            for (int i = 0; i < N_matrix; i++)
            {
        ...
        {
            int detA = this.Determinant_4_Hau();
        ...
        public Matrix_Int_4_Hau Adjugate()
        {
            ...
            Matrix_Int_4_Hau return_matrix = new Matrix_Int_4_Hau(N_matrix);
            int flag_i = 1;
            for (int i = 0; i < N_matrix; i++)
            {
                int flag_j = 1;
